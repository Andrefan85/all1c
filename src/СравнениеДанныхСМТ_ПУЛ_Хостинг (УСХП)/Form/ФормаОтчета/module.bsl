...
Процедура ОбновитьОтчет() Экспорт
	...
	СтруктураНастроекСМТ.Вставить("СвойствоАТЗ",СвойствоАТЗ);
...
Процедура ДействияФормыСформировать(Кнопка)
	...
	Если (НЕ ЗначениеЗаполнено(ХранениеИдТехники)) ИЛИ (НЕ ЗначениеЗаполнено(СвойствоАЗС)) ИЛИ (НЕ ЗначениеЗаполнено(СвойствоАТЗ)) Тогда
...
Процедура ПриОткрытии()
	...
	СвойствоАТЗ = ВосстановитьЗначение("СвойствоАТЗ");
	Если СвойствоАТЗ = Неопределено Тогда
		Если СтруктураНастроекПоУмолчанию.Свойство("СвойствоАТЗ") Тогда
			СвойствоАТЗ = СтруктураНастроекПоУмолчанию["СвойствоАТЗ"]; 	
		КонецЕсли;
	Иначе
		СвойствоАТЗ = ВосстановитьЗначение("СвойствоАТЗ")
	КонецЕсли;	
...
Процедура ПриЗакрытии()
	...
	СохранитьЗначение("СвойствоАТЗ", 			СвойствоАТЗ); 
